...
const HOME_CARDS = [
  { href: "/personal-study", icon: "✍️", title: "じぶんの研究", text: "自分の研究を作成・途中保存", tone: "green" },
  { href: "/study", icon: "📖", title: "ふたりの研究", text: "2人で研究内容を共有", tone: "coral" },
  { href: "/notes", icon: "🪶", title: "研究ノート", text: "研究をカテゴリー別に検索", tone: "blue" },
  { href: "/resources", icon: "🗂️", title: "資料置き場", text: "JW.ORG資料や年代表", tone: "purple" },
  { href: "/ministry", icon: "🗣️", title: "伝道情報", text: "証言に役立つ情報を整理", tone: "gold" },
  { href: "/tasks", icon: "✅", title: "タスク", text: "今日したいことを管理", tone: "mint" },
];
...
export default function HomePage() {
  ...
  return (
    <div className="treasure-home">
      ...
      {partnerPresence && (
        <section className="live-reading-banner" aria-live="polite">
          ...
          <div>
            ...
            <span>{formatChapter(partnerPresence.ref)}</span>
          </div>
        </section>
      )}
      ...
      <section className="home-quick-grid six-cards" aria-label="主な機能">
        {HOME_CARDS.map((card) => (
          <a href={card.href} className={`quick-card ${card.tone}`} key={card.href}>
